...
**Status:** Planning complete. **Phases A–E landed** — publication registry, resolution, status/edition labels, What’s New event model, and public `/whats-new` page (filters, RSS, homepage preview). Book overview redesign remains Phases F–G.
