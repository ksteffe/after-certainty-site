...
**Status:** Planning only — do not implement features from this document until a dedicated implementation phase begins.

**Scope of this change:** This planning document only. No production code, dependency installs, or feature implementation.
...
*End of plan. Implementation should proceed in phases A–H above without creating a second manually maintained title/cover catalog and without exposing drafts or technical rebuild noise.*
